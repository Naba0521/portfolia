  ...
  return (
    <div className=" w-[100%] bg-[#F9FAFB] dark:bg-[#111827]" id="experience">
      <div className="w-[90%] m-auto flex flex-col gap-[48px]  h-max rounded-[20px] py-[24px]">
        ...
        <div className="flex flex-col  lg:flex lg:flex-row lg:gap-5 items-center w-[90%] m-auto bg-white dark:bg-[#1F2937] gap-[16px] rounded-[20px] px-[32px] py-[32px] shadow-xl dark:text-[#F9FAFB]">
        ...
        <div className="flex flex-col lg:flex lg:flex-row lg:gap-5 items-center w-[90%] m-auto bg-white dark:bg-[#1F2937] rounded-[20px] px-[32px] py-[32px] shadow-xl dark:text-[#F9FAFB]">
